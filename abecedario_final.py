            ...
            for num, hand_landmarks in enumerate(results.multi_hand_landmarks):
                ...
                if abs(thumb_tip[1] - index_finger_pip[1]) <45 \
                   ...
                   cv2.putText(image, 'C', (700, 150), 
                    ...
                    and distancia_euclidiana(thumb_tip, ring_finger_tip) < 65 and distancia_euclidiana(thumb_tip, pinky_tip) < 65\
                ...
                elif abs(index_finger_tip[1] - thumb_tip[1]) < 100 and \
                    index_finger_tip[1] - middle_finger_pip[1]<0 and index_finger_tip[1] - middle_finger_tip[1] < 0 and \
                    not index_finger_tip[1] - index_finger_pip[1] > 0 and distancia_euclidiana(ring_finger_tip, pinky_tip) < 65:
                   cv2.putText(image, 'G', (700, 150), 
                                cv2.FONT_HERSHEY_SIMPLEX, 
                                3.0, (0, 0, 255), 6)
                   
                elif abs(index_finger_tip[1] - thumb_tip[1]) < 100 and \
                    not index_finger_tip[1] - index_finger_pip[1] > 0 and distancia_euclidiana(index_finger_tip, middle_finger_tip) < 55 and distancia_euclidiana(ring_finger_tip, pinky_tip) < 65:
                   cv2.putText(image, 'H', (700, 150), 
                                cv2.FONT_HERSHEY_SIMPLEX, 
                                3.0, (0, 0, 255), 6)   
                   
                elif index_finger_pip[1] - index_finger_tip[1] < 0 and pinky_pip[1] - pinky_tip[1] > 0 and \
                    middle_finger_pip[1] - middle_finger_tip[1] < 0 and ring_finger_pip[1] - ring_finger_tip[1] < 0 or distancia_euclidiana(thumb_tip, ring_finger_tip) < 65 \
                        and abs(index_finger_tip[1] - thumb_tip[1]) < 100 and \
                            thumb_tip[1] - index_finger_tip[1] > 0 \
                            and thumb_tip[1] - middle_finger_tip[1] > 0 \
                            and thumb_tip[1] - ring_finger_tip[1] > 0 \
                    ...
                    middle_finger_pip[1] - middle_finger_tip[1] > 0 and ring_finger_pip[1] - ring_finger_tip[1] > 0 \
                        and abs(index_finger_tip[1] - thumb_tip[1]) < 100 and thumb_tip[1] - pinky_tip[1]<0 and \
                            thumb_tip[1] - index_finger_tip[1] < 0\
                            and thumb_tip[1] - middle_finger_tip[1] < 0 \
                            and thumb_tip[1] - ring_finger_tip[1] < 0 \
                            and thumb_tip[1] - pinky_tip[1] < 0:
